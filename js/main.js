		...
		$(document).ready(function() {
			...
			// Intro animation
			controller.addTween('#green', TweenMax.from( $('#green'), .5, {css:{opacity: 0}}), scrollDuration);
			controller.addTween('#yellow', TweenMax.from( $('#yellow'), .25, {css:{right:'1000px'}, ease:Quad.easeInOut}), scrollDuration);
			controller.addTween('#yellow', TweenMax.from( $('#yellow'), .25, {css:{right:'1000px'}, ease:Quad.easeInOut}), scrollDuration);
